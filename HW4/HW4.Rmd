...
pnames = c("v", "height", "zm_add", "k_o", "k_d")
...
# I don't think this worked.. it looks very odd
...
# I got kind of confused here on which variables to use in which order/if it matters??
parm[,"v"] = qnorm(parm_quant[,"v"], mean=-0.015, sd=0.015/pvar)
parm[,"height"] = qnorm(parm_quant[,"height"], mean=-0.0046, sd=0.0046/pvar)
